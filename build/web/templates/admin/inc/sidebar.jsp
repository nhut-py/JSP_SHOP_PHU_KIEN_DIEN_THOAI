...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<%=request.getContextPath()%>/admin" class="brand-link">
        <img src="<%=request.getContextPath()%>/templates/admin/dist/img/logi.png" alt="Shop ốp lưng" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Shop phụ kiện</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<%=request.getContextPath()%>/templates/admin/dist/img/avatar5.png" class="img-circle elevation-2" alt="User Image">
            </div>
