        ...
        <div class="pageWrap">
            ...
            <div class="tp-bar">
                <div class="container">
                    <ul class="tp-links">
                        <li>
                            <span class="dropBox-btn">Xin chào &nbsp; <%=userInfor.getFullname()%></span>
                        </li>
                        <li>
                            <span><a href="<%=request.getContextPath()%>/views/auth/logout.jsp">Đăng xuất</a></span>
                        </li>
                    </ul>
                    <!-- /tp-links -->
                </div>
            ...
            <div class="main-bar">
                <div class="logo">
                    <a href="index-2.html"><img
                            src="<%=request.getContextPath()%>/templates/public/images/logi.png"
                            alt="perfume"></a>
                </div>
                <!-- /logo -->
                ...
                <div class="main-nav-bar">
                    <nav class="navbar-collapse collapse">
                        <ul class="main-nav">
                            ...
                            <li>
                                <a href="<%=request.getContextPath()%>/home">Hãng</a>
                                <ul>
                                    <%
