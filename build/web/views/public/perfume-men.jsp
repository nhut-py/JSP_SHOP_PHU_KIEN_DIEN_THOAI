            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail thumbnail-product">
                    ...
                    <div class="caption text-center">
                        ...
                        <p class="prod-price text-primary"><%=objView.getMoney()%> đ</p>
                        <div class="row">
                            <div class = "col-md-5">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail thumbnail-product">
                    ...
                    <div class="caption text-center">
                        ...
                        <p class="prod-price text-primary"><%=perAllNew.getMoney()%> đ</p>
                        <div class="row">
                            <div class = "col-md-5">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail thumbnail-product">
                    ...
                    <div class="caption text-center">
                        ...
                        <p class="prod-price text-primary"><%=allProduct.getMoney()%> đ</p>
                        <div class="row">
                            <div class = "col-md-5">
