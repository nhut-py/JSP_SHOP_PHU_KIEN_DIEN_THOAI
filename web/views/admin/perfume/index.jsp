	      ...
	      <div class="col-sm-6">
            <form method="GET" action="<%=request.getContextPath()%>" class="form-inline">
				<select id="cars" class="btn-sm form-control">
                 ...
                 <input type="search" name="nameCat" value=""class="form-control" placeholder="Nhập tên sản phẩm" style="float:right; width: 300px;" />
        ...
        <table class="table table-striped table-bordered">
		  <thead>
		    <tr>
		      ...
		      <th scope="col">Chức năng &emsp;<a href="<%=request.getContextPath()%>/admin/perfume/add" class="btn btn-success btn-md">Thêm</a></th>
		    </tr>
		  </thead>
		  <tbody>
		  <%
