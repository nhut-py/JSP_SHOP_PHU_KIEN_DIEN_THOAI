            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail thumbnail-product">
                    ...
                    <div class="caption text-center">
                        ...
                        <p class="prod-price text-primary"><%=objEVA.getMoney()%> đ</p>
                        <div class="row">
                            <div class = "col-md-5">
                ...
                <div class="featured-box">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            %>
                            <figure class="image">
                                <img src="../../templates/public/images/iphone14.jpg" alt="image">
                                <%--<%=request.getContextPath()%>/uploads/images/product/<%=picV%>--%>
                            </figure>
                            <%
                            } else {
                            %>
                            <figure class="image">
                                <img src="<%=request.getContextPath()%>/templates/public/images/iphone14.jpg" alt="image">
                                <!--/templates/public/images/noimage.gif-->
                            </figure>
                            <%
                                }
                            %>
                        ...
                        <div class="col-sm-7">
                            <div class="text">
                                <p>Hãng: <a href="product-single.html" class="text-primary"><%=objPFLView.getBrand()%></a></p>
                                <h4>Tên sản phẩm: <%=objPFLView.getPerfumes()%></h4>
