            ...
            <div class="row">
                <div class="col-sm-5 col-lg-4">
                    ...
                    <ul class="contact-list">
                        <li><span class="iconic"><i class="flaticon-call36"></i></span>0394915710</li>
                        <li><span class="iconic"><i class="flaticon-email15"></i></span><a href="#">nhutnhut.pip@gmail.com</a></li>
